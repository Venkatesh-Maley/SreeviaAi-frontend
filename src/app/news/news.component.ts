...
export class NewsComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   posts = [
    { title: 'AI meeting conducted by the IESA.', description: 'SreeVia AI CEO attend an AI meeting conducted by the India Electronics and Semiconductor Association (IESA).', date: 'November 7, 2023', image: 'image3.jpg' },
    { title: 'SreeVia Ai recognized by Global C-Suite Community platform', description: 'SreeVia AI Technologies has been recognized with a prestigious award for AI Innovation.', date: 'December 7, 2024', image: 'image1.png' },
